...
describe('BudgetController.getById', () => {
    ...
    it('should return a budget with ID 1 an 3 expenses', async () => {
    ...
    it('should return a budget with ID 2 an 2 expenses', async () => {
    ...
    it('should return a budget with ID 3 an 0 expenses', async () => {
